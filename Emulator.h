...
enum {SELECT_ROM_BUTTON = wxID_HIGHEST + 1,
      ...
      MOVE_LEFT_BUTTON = wxID_HIGHEST + 4,
      MOVE_RIGHT_BUTTON = wxID_HIGHEST + 5};

ROM ALL_ROMS[] = {INVADERS, SEAWOLF, GUNFIGHT};
const int ROM_AMOUNT = 3;
...
class MainFrame : public wxFrame { 
 public:
  ...
  void MoveLeft(wxCommandEvent & event);
  void MoveRight(wxCommandEvent & event);
